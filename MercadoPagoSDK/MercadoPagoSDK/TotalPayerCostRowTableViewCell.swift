...
class TotalPayerCostRowTableViewCell: UITableViewCell {
    ...
    public func fillCell(total: Double) {
        ...
        let attributedTotal = NSMutableAttributedString(attributedString: NSAttributedString(string: LocalizableStringsUtil.TOTAL + ": ", attributes: [NSForegroundColorAttributeName: UIColor.black]))
